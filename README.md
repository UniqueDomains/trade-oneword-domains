# Available .TRADE One-Word Domains (5,622,081)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C824%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-5%2C622%2C081%20domains-6f42c1">
...
> **Important:** this repository is a **public 8,824-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,081 domains** on the canonical page below.

**Public extract:** 8,824 rows · **Live catalog:** 5,622,081 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/trade?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_trade_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/trade?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_trade_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./trade.csv">CSV</a> / <a href="./trade.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_trade_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_trade_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .TRADE search](https://unique.domains/domains/tld/trade?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_trade_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .TRADE search](https://unique.domains/domains/tld/trade?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_trade_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./trade.csv) or [Download JSON](./trade.json)
...
- `trade.csv` — public CSV extract (8,824 rows)
- `trade.json` — public JSON extract (8,824 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,824-row public sample | 5,622,081 live domains                           |
...
| taiwan.trade     | resell    | —         | —             | 66             | 92     | 6      | Global Domains International, Inc. DBA DomainCostClub.com |
| nationwide.trade | premium   | $437.50   | $62.50        | 76             | 66     | 10     | name.com                                                  |
| curative.trade   | available | $9.98     | —             | 92             | 27     | 8      | namecheap                                                 |
| lens.trade       | resell    | —         | —             | 62             | 71     | 4      | Dynadot Inc                                               |
...
| stretch.trade    | available | $9.98     | —             | 100            | 26     | 7      | namecheap                                                 |
...
| silly.trade      | available | $9.98     | —             | 82             | 25     | 5      | namecheap                                                 |
...
> Unique Domains. *Available .TRADE One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
