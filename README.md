...
- `trade.csv` — public CSV extract (8,823 rows)
- `trade.json` — public JSON extract (8,823 rows)
...
> Unique Domains. *Available .TRADE One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
